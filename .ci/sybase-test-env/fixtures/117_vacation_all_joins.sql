-- @desc: Vacation query completa com TODOS os JOINs (foempregados + geempre
-- + customers_tax_numbers + focargos + fodepto + foferias*) e subqueries
-- correlated com JSON_AGG. Originalmente em pg_test sybase_vacation_with_all_joins
-- — surgiu como regressão depois de uma versão com `vinculo = 'Celetista'`
-- (string) crashar em smallint.
-- @expect: ok
