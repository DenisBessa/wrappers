...
class MockTDSServer:
    ...
    def create_prelogin_response(self):
        ...
        prelogin_data = bytes([
            ...
            0xff,                          # Terminator
            # VERSION value
            0x0f, 0x00, 0x07, 0xd1, 0x00, 0x00,
            # ENCRYPTION value (0 = off)
            0x00,
            # INSTOPT value
            0x00
        ])
    ...
    def create_packet(self, packet_type, data):
        ...
        header += bytes([0x00, 0x00, 0x01, 0x00])  # SPID and packet number
